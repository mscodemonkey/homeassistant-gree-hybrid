"""Support for Gree Hybrid Hot Water Heat Pump (HWHP) devices."""
...
async def async_setup_entry(
    ...
    """Set up Gree Hybrid HWHP water heater devices from a config entry."""
...
class GreeCloudWaterHeaterEntity(GreeCloudEntity, WaterHeaterEntity):
    """Representation of a Gree Hybrid Hot Water Heat Pump."""
    ...
    def __init__(self, coordinator: DeviceDataUpdateCoordinator) -> None:
        """Initialize the Gree Hybrid HWHP entity."""
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        device.set_raw_property(HWHP_PROP_SET_TEM_INT, int(temperature))
        device.set_raw_property(HWHP_PROP_SET_TEM_DEC, 0)
    ...
    async def async_set_operation_mode(self, operation_mode: str) -> None:
        ...
        if operation_mode == STATE_OFF:
            ...
            device.power = True
            wmod = (
                HWHP_WMOD_BOOST if operation_mode == HWHP_OPERATION_BOOST else HWHP_WMOD_HEAT_PUMP
            )
            device.set_raw_property(HWHP_PROP_WMOD, wmod)

"""Support for Gree Hybrid climate devices."""
...
class GreeCloudClimateEntity(GreeCloudEntity, ClimateEntity):
    """Representation of a Gree Hybrid HVAC device."""
    ...
    def target_temperature_step(self) -> float:
        ...
        return (
            TARGET_TEMPERATURE_STEP_HALF if self._supports_half_degree else TARGET_TEMPERATURE_STEP
        )
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        if units == TemperatureUnits.C and self._attr_temperature_unit != UnitOfTemperature.CELSIUS:
